        ...
        <div className="p-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <span className="text-gray-600">{userIdToUsernameMap[post.userId]}</span>
                </div>
              </div>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="font-medium text-gray-900 mb-1">Post ID</h3>
              <span className={`inline-flex px-2 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800`}>
                {post.id}
              </span>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="font-medium text-gray-900 mb-1">User ID</h3>
              <span className={`inline-flex px-2 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800`}>
                {post.userId}
              </span>
            </div>
